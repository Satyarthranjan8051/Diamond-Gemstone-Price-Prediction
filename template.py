...
for filepath in list_of_files:
    ...
    """how exist_ok works: if "directory"already exists, os.makedirs() will
    not raise an error, and it will do nothing. if "my_directory" doesn't exist, it will create the directory.
    """
